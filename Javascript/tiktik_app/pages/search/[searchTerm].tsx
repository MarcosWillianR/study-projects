...
const Search = ({ videos }: { videos: IVideo[] }) => {
  ...
  const accounts = useMemo(() => isAccounts ? 'border-b-2 border-black' : 'text-gray-400', [isAccounts]);
  const isVideos = useMemo(() => !isAccounts ? 'border-b-2 border-black' : 'text-gray-400', [isAccounts]);
